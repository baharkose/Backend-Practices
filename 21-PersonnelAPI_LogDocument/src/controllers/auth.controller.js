...
module.exports = {
  ...
  login: async (req, res) => {
    // #swagger -> tek satırlık düzenleme
    /*
        #swagger.tags = ["Authentication"]
        #swagger.summary = "Login"
        #swagger.description = "Login with username and password"
        // swagger bazen parametreleri yakalayamabiliyor o zaman ne yapmamız lazım
        // şu verileri bana örnek olarak yolla
        // parametreleri tam yakalayınca rty it out ile canlı test ortamı verir.
