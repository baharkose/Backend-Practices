...
const document = {
  ...
  // ! bu alan çok önemli. Asıl yapmamız gereken iş burada
  definitions: {
    "/auth/login": {
      username: {
        type: "String",
...
//indexten taramaya başla ve bana bunları ver. route taramasına indexden   başla ve aşağıdaki dosyaya bu routeları yaz.
