...
module.exports = (req, res, next) => {
  ...
  // Run for output:
  // modele göre sayfalama sıralama yap.
  //   customFiltering getModelListi kullanırken kendimiz bir filtreleme yapmak istersek. GetModelList metodunu çağırırken filtreleme yapmak istersek o zaman ikinci parametre olarka filterleme imkanı sağlamış olduk.
